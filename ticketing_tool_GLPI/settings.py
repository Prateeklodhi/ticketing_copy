"""
Django settings for ticketing_tool_GLPI project.
...
SECRET_KEY = 'django-insecure-f87fpt4p9cfq3b(1r!wx&h6b+!nb-)i2uac5l)aik$ufrdqv*='
...
ROOT_URLCONF = 'ticketing_tool_GLPI.urls'
...
WSGI_APPLICATION = 'ticketing_tool_GLPI.wsgi.application'
